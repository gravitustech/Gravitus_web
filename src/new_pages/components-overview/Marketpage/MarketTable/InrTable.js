...
const rows = [
  createData(<MyComponent id={1} />, <BitcoinIcon />, 'EPX / INR', '₹26,625.256', '+1.54% ', 40, 22, 'Trade'),
  createData(<MyComponent id={2} />, <BitcoinIcon />, 'ACH / INR', '₹19,85.202', '+2.85% ', 36, 63, 'Trade'),
  createData(<MyComponent id={3} />, <BitcoinIcon />, 'LINK / INR', '₹125.02365', '+8.85% ', 52, 78, 'Trade')
];
...
export default function INRTable({ marketData }) {
