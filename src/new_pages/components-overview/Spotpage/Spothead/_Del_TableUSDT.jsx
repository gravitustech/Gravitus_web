...
const rows = [
  createData(
    <MyComponent id={1} />,
    <BitcoinIcon />, 'BTC / USDT', '$26,625.256', '+1.54% ',),
  createData(
    <MyComponent id={2} />,
    <BitcoinIcon />, 'ETH / USDT', '$19,85.202', '+2.85% ',),
  createData(
    <MyComponent id={3} />,
    <BitcoinIcon />, 'EPX / USDT', '$125.02365', '+8.85% ',),
  createData(
    <MyComponent id={4} />,
    <BitcoinIcon />, 'LINK / USDT', '$166.3253', '+3.85% ',),
];
...
export default function USDTTable() {
  const theme = useTheme();
