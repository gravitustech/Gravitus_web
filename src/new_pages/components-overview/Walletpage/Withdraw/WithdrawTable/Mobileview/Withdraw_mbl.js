...
import { Button, Card, Tooltip, CircularProgress, Dialog, Divider, Drawer, Grid, Link, Stack, Typography, useTheme } from '@mui/material';
import Norecordfoundcomponents from '../../../_Essentials/NoRecordFound';
import CloseIcon from '@mui/icons-material/Close';

const Withdraw_mbl = ({ historyData }) => {
