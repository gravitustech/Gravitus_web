...
const Trade_Buyer_Dts_Ext = ({ SUPERData, setSnackbarOpen, setSnackbarMessage }) => {
    ...
    if (croppedImage != undefined) {
      ...
      formDataP2P(P2P_ReleaseRequest_URL(), postData).then(function (res) {
        ...
        if (res.error !== 'ok') {
          ...
          setSnackbarMessage({ msg: 'Notified successfully', success: false });
          setSnackbarOpen(true);
        ...
        return (
          <Stack pt={2} pl={2} pr={2} sx={{ color: theme.palette.mode === 'dark' ? 'text.primarydark' : 'text.primary' }}>
            ...
            <Stack pt={2} direction="row" justifyContent="space-between" alignItems="center" spacing={1}>
              ...
              <Typography variant="h4" sx={{ color: theme.palette.mode === 'dark' ? 'text.buy' : 'text.buy' }}>
            ...
            <Stack direction="row" spacing={1} pt={1} sx={{ color: theme.palette.mode === 'dark' ? 'text.primarydark' : 'text.primary' }}>
          ...
          <>
            {!isHidden ? (
              <Stack pt={2} pl={2} pr={2} sx={{ color: theme.palette.mode === 'dark' ? 'text.primarydark' : 'text.primary' }}>
                ...
                <Stack direction="row" spacing={3} pt={3}>
                  {
                    SUPERData?.actionLabel_2 === 'Cancel Appeal' ? (
                      <>
                      ...
                      <>
                        {
                          SUPERData?.actionLabel_2 === 'Appeal' ? (
                            <>
        ...
        return (
          <Stack>
            {SUPERData?.actionCaption === "Order Timed Out" ? (
              <>
                {!isHidden ? (
                  <Stack pt={0} pl={2} pr={2} sx={{ color: theme.palette.mode === 'dark' ? 'text.primarydark' : 'text.primary' }}>
      ...
      <Box sx={{ width: '100%' }} pt={5}>
        <Stepper activeStep={activeStep} connector={<ColorlibConnector />}>
          {steps.map((label, index) => {
            ...
            return (
              SUPERData?.actionCaption === "Order Timed Out" || SUPERData?.superStatus >= 3 ? (
                <></>
              ) : (
