...
const Orderbook = ({ orderBookData, marketTradesData, setSelectedOrder,priceData,isAuthorised}) => {
  ...
  return (
    <TabContext value={value}>
      ...
      <TabPanel value="0" sx={{ padding: '0' }}>
        <Orderbooktab orderBookData={orderBookData} setSelectedOrder={setSelectedOrder}  priceData={priceData} isAuthorised={isAuthorised}/>
      </TabPanel>
