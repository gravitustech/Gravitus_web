...
const BuyLimitStoplimittab = ({ isAuthorised }) => {
          ...
          {({ errors, handleBlur, handleChange, handleSubmit, isSubmitting, touched, values }) => (
            <form noValidate onSubmit={handleSubmit}>
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  {isAuthorised ? (
                    <Button disableElevation disabled={isSubmitting} type="submit" variant="spotbuybutton" onClick={handleClickOpenDialog}>
                      BUY
                    </Button>
                  ) : (
                    <Button disableElevation disabled={isSubmitting} variant="spotbuybutton" onClick={() => navigate('/login')}>
                      LOGIN
                    </Button>
                  )}
                  ...
                  <Dialog open={openDialog} onClose={handleCloseDialog} aria-labelledby="dialog-title">
                    <Stack p={4} spacing={2.5}>
                      ...
                      <Stack pt={1} direction="row" spacing={2} justifyContent="space-between">
                        ...
                        <Button variant="contained4">Confirm</Button>
                      </Stack>
                      <Stack>
                        <Typography
                          variant="body1"
...
export default BuyLimitStoplimittab;
