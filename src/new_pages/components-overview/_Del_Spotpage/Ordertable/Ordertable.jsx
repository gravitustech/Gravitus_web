...
const Ordertable = ({ isAuthorised, orderTableData, priceData }) => {
  ...
  const tabData = [
    {
      value: '0',
      label: 'Open Orders',
      screen: <OpenordersTab isAuthorised={isAuthorised} orderTableData={orderTableData} priceData={priceData} />
    },
    {
      value: '1',
      label: 'Order History',
      screen: <HistroyordersTab isAuthorised={isAuthorised} orderTableData={orderTableData} priceData={priceData} />
    }
  ];
  return (
    <Grid>
