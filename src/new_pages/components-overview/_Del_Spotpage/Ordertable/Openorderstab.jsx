...
function createData(Type, Price, StopPrice, Quantity, TotalAmount, AfterFees, Date, Action) {
  return { Type, Price, StopPrice, Quantity, TotalAmount, AfterFees, Date, Action };
}
const rows = [
  createData('BTC/USDT', '26,568.00', '26,568.00', '0.01253', '26.62425', '--', '26 Dec, 12PM', 'Cancel'),
  createData('BTC/USDT', '27,568.00', '27,568.00', '0.01253', '26.62425', '--', '26 Dec, 12PM', 'Cancel'),
  createData('BTC/USDT', '28,568.00', '28,568.00', '0.01253', '26.62425', '--', '26 Dec, 12PM', 'Cancel'),
  createData('BTC/USDT', '29,568.00', '29,568.00', '0.01253', '26.62425', '--', '26 Dec, 12PM', 'Cancel')
];
...
export default function OpenordersTab({ isAuthorised, orderTableData, priceData }) {
  const theme = useTheme();
  console.log('sd', orderTableData?.ongoing?.length);
  return (
    <>
      {isAuthorised ? (
        <Box>
