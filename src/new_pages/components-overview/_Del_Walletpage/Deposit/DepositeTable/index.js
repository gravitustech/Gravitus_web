...
function createData(Amount, Fees, Address, TransactionId, Status, Date) {
  return { Amount, Fees, Address, TransactionId, Status, Date };
}
const rows = [
  createData('0.012BTC', '0.0025 BTC', '1A1zP1eP5QGefi2DMpPTfTL5SLmv7DivfNa', '1A1zP1eP5QGefi2DMpPTf...', 'Processed', '26 Dec, 12PM'),
  createData('0.012BTC', '0.0025 BTC', '1A1zP1eP5QGefi2DMpPTfTL5SLmv7DivfNa', '1A1zP1eP5QGefi2DMpPTf...', 'Processed', '26 Dec, 12PM')
];
