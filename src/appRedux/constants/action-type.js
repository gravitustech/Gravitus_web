...
//Menu
export const SET_ACTIVE_ITEM = 'setActiveItem';
export const SET_ACTIVE_COMPONENT = 'setActiveComponent';
export const SET_OPEN_DRAWER = 'setOpenDrawer';
export const SET_OPEN_COMPONENT_DRAWER = 'setOpenComponentDrawer';
